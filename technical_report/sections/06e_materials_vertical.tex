\subsection{Simplifying a Published Method: Materials Generation}
...
campaign targets metal--organic framework (MOF) generation, and its outcome is the
sharpest instance in this report of the pattern Section~\ref{sec:method} describes:
the admitted result is \emph{simpler} than the method it replaces, and it was
admitted only after a confound in the original comparison was removed.
