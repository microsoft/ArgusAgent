    ...
    "benchmark": _checklist(
        ...
        ChecklistItem(
            ...
            statement=(
                ...
                "the published one means your pipeline is what you measured. Report "
    ...
    "draft": _checklist(
        ChecklistItem(
            ...
            statement=(
                ...
                "apology has put the excuse where the result belongs. Claim as far as "
...
_PLANNER_RESEARCH_ORCHESTRATION = (
    ...
    "improve for the rest of the campaign. Cheapest means no redundant condition, "
    "never too few examples to see the margin you just declared: three campaigns "
    "read it the other way and claimed wins of three examples on 120 and of one "
    "example on 48, which no reviewer will read as a result. Size the evaluation "
    "so the declared margin is bigger than the spread of your own repeats, and if "
    "that does not fit the budget, the margin or the budget is what changes. Short of the baseline is a gap with a "
